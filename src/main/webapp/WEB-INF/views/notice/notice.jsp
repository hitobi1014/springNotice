		...
		<ul class="pagination">
			<c:choose>
				...
				<c:otherwise>
					...
					<li><a
						href="${cp}/notice?page=${page-1}&ntgu_code=${ngvo.ntgu_code}">&lt;</a></li>
				</c:otherwise>
			</c:choose>
			...
			<c:forEach var="i" begin="1" end="${pages}">
				<c:choose>
					...
					<c:otherwise>
						<li><a
							href="${cp}/notice?page=${i}&ntgu_code=${ngvo.ntgu_code}">${i}</a></li>
					</c:otherwise>
				</c:choose>
			</c:forEach>
			...
			<c:choose>
				...
				<c:otherwise>
					<li><a
						href="${cp}/notice?page=${page+1}&ntgu_code=${ngvo.ntgu_code}">&gt;</a></li>
					<li><a
						href="${cp}/notice?page=${pages}&ntgu_code=${ngvo.ntgu_code}">&gt;&gt;</a></li>
				</c:otherwise>
			</c:choose>
